...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        [
            'name' => "Laptop Asus TUF Gaming FX516PM",
            'type_id' => 3,
        ...
        [
            'name' => "Laptop Acer Predator Triton 300 PT315",
            'type_id' => 3,
        ...
        [
            'name' => "Laptop MSI Gaming Leopard GP76",
            'type_id' => 3,
        ...
        [
            'name' => "Laptop MSI Gaming GS66 Stealth",
            'type_id' => 3,
        ...
        [
            'name' => "Laptop Gigabyte Gaming G5",
            'type_id' => 3,
